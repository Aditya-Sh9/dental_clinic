...
// Temporary fix - remove users join
...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-2xl font-bold text-green-900">Treatment Plan</h1>
                <div class="flex space-x-2">
                    ...
                    <a href="treatment_plans.php" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg shadow transition flex items-center">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-8 border-l-4 border-green-600">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-green-900 mb-2">Plan Details</h2>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-green-600">
                <div class="border-b border-gray-200">
                    <nav class="flex -mb-px">
                        <button id="notes-tab" class="py-4 px-6 text-center border-b-2 font-medium text-sm border-green-600 text-green-600">
                ...
                <div id="notes-content" class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-xl font-semibold text-green-900">Notes</h2>
                        <button onclick="openNoteModal()" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg shadow transition flex items-center">
                    ...
                    <?php if($notes->num_rows > 0): ?>
                        <div class="space-y-4">
                            ...
                            <div class="border rounded-lg p-4 note-item hover:shadow-md transition">
                                <div class="flex justify-between items-start mb-2">
                                    <div>
                                        <p class="font-medium text-green-900"><?= htmlspecialchars($note['author']) ?></p>
                ...
                <div id="documents-content" class="p-6 hidden">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-xl font-semibold text-green-900">Documents</h2>
                        <button onclick="openDocumentModal()" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg shadow transition flex items-center">
                    ...
                    <?php if($documents->num_rows > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            ?>
                            <div class="border rounded-lg p-4 hover:shadow-md transition document-item">
                                <div class="flex items-center mb-2">
                                    <i class="fas <?= $icon ?> text-green-600 text-xl mr-3"></i>
                                    <div>
                                        <h3 class="font-medium text-green-900 truncate"><?= htmlspecialchars($doc['file_name']) ?></h3>
    ...
    <div id="note-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
            <h3 class="text-lg font-semibold text-green-900 mb-4">Add New Note</h3>
            <form id="note-form" action="add_treatment_note.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="note" id="note" rows="4" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required></textarea>
                </div>
    ...
    <div id="document-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
            <h3 class="text-lg font-semibold text-green-900 mb-4">Upload Document</h3>
    ...
    <script>
        ...
        document.getElementById('notes-tab').addEventListener('click', function() {
            ...
            document.getElementById('documents-tab').classList.remove('border-green-600', 'text-green-600');
        ...
        document.getElementById('documents-tab').addEventListener('click', function() {
            this.classList.add('border-green-600', 'text-green-600');
            this.classList.remove('border-transparent', 'text-gray-500', 'hover:text-gray-700', 'hover:border-gray-300');
            document.getElementById('notes-tab').classList.remove('border-green-600', 'text-green-600');
