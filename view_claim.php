    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-2xl font-bold text-green-900">Claim Details</h1>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-8 border-l-4 border-green-600">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <h2 class="text-lg font-semibold text-green-900 mb-2">Claim Information</h2>
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-green-900 mb-2">Financial Information</h2>
                ...
                <div class="mb-6">
                    <h2 class="text-lg font-semibold text-green-900 mb-2">Procedure Description</h2>
                    <p class="text-gray-700"><?= htmlspecialchars($claim['procedure_description']) ?></p>
                </div>
                
                <div>
                    <h2 class="text-lg font-semibold text-green-900 mb-2">Notes</h2>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-600">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-lg font-semibold text-green-900">Documents</h2>
