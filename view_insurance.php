    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-2xl font-bold text-blue-800">Insurance Policy Details</h1>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <h2 class="text-lg font-semibold text-blue-800 mb-2">Policy Information</h2>
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-blue-800 mb-2">Coverage Details</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h2 class="text-lg font-semibold text-blue-800 mb-2">Deductible Information</h2>
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-blue-800 mb-2">Additional Information</h2>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-blue-800">Policy Documents</h2>
                    <a href="upload_insurance_doc.php?insurance_id=<?= $insurance_id ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow transition flex items-center">
