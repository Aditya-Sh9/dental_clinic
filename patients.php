    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-2xl font-bold text-blue-800">Patient Management</h1>
                <a href="add_patient.php" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow transition flex items-center">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-blue-50">
                            <tr>
                                <th class="p-4 text-left text-blue-800">Name</th>
                                <th class="p-4 text-left text-blue-800">Email</th>
                                <th class="p-4 text-left text-blue-800">Phone</th>
                                <th class="p-4 text-left text-blue-800">DOB</th>
                                <th class="p-4 text-left text-blue-800">Gender</th>
