    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-2xl font-bold text-blue-800">Edit Patient</h1>
                <a href="patients.php" class="text-blue-600 hover:text-blue-800 font-medium">
            ...
            <form method="POST" class="max-w-lg bg-white p-6 rounded-xl shadow-md">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="mb-4">
                    ...
                    <select name="gender" id="gender" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="address" id="address" rows="3" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo htmlspecialchars($patient['address']); ?></textarea>
                </div>
